 ...
 * </p>
 *
 * Created by Richard Masoumi on 28/3/17, based on the code in 'agi' by Gideon.
 */

public class MnistDataFile implements Iterable< MnistDataFile.Tuple< BufferedImage, String > > {

    // magic numbers defined on the " FILE FORMATS FOR THE MNIST DATABASE" section
    // of mnist webpage (http://yann.lecun.com/exdb/mnist/). This numbers are used for validation.
